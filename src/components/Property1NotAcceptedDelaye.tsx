...
export type Property1NotAcceptedDelayeType = {
  gUC153?: string;
  quantity?: boolean;
...
const Property1NotAcceptedDelaye: FunctionComponent<
  Property1NotAcceptedDelayeType
> = ({
  gUC153,
  quantity,
  showCheckBox,
  ...
  return (
    <div className="w-[360px] max-w-full flex flex-col items-start justify-start text-left text-xs text-text-text-dark font-button-button-text-secondary">
      <div className="self-stretch rounded-regular2 bg-background-background-primary flex flex-col items-start justify-start p-2 gap-[12px] border-[0.5px] border-solid border-default-grey">
        <div className="self-stretch flex flex-row items-center justify-start text-background-background-primary font-text-description-text">
          <div className="flex flex-row items-center justify-start gap-[4px]">
            <div className="rounded bg-background-grey-light flex flex-row items-center justify-start py-0.5 px-1 gap-[5px] text-text-text-dark font-button-button-text-secondary">
              <img
            ...
            <div className="rounded-xl bg-background-grey-light flex flex-row items-center justify-center py-small px-regular1 text-accent-danger-accent">
              <div className="relative font-medium">Not Accepted</div>
            </div>
            <div className="w-16 rounded bg-accent-danger-accent h-5 hidden flex-row items-center justify-center p-1 box-border text-3xs">
              <div className="relative font-medium">Delayed</div>
            </div>
            <div className="w-16 rounded bg-accent-danger-accent h-5 overflow-hidden shrink-0 hidden flex-row items-center justify-center p-1 box-border text-3xs">
              <div className="relative font-medium">Complaint</div>
            </div>
            <div className="rounded-xl bg-background-grey-light flex flex-row items-start justify-start py-0.5 px-1">
              <img
          ...
          <div className="flex-1 flex flex-col items-end justify-start text-sm text-accent-danger-accent">
            <div className="rounded-xl bg-mistyrose flex flex-row items-center justify-start py-smaller px-small2 gap-[4px]">
              <img
                className="w-smaller1 relative h-smaller1 overflow-hidden shrink-0"
                alt=""
                src="/access-time.svg"
              />
              <div className="relative font-medium">1min</div>
            </div>
          </div>
        </div>
        ...
        <div className="w-[319px] bg-background-grey-light hidden flex-col items-start justify-start p-3 box-border gap-[12px] font-text-description-text">
          ...
          <div className="self-stretch rounded-regular1 bg-default-color-primary flex flex-row items-center justify-center py-regular1 px-mediium1 gap-[8px] text-default-color-primary-light font-button-button-text-secondary">
            <img className="w-small3 relative h-small3" alt="" src={gUC153} />
            <div className="relative font-medium">Accept Task</div>
          </div>
        </div>
        <div className="self-stretch rounded-small3 bg-accent-danger-accent flex flex-row items-center justify-center py-regular1 px-mediium1 gap-[8px] text-default-color-primary-light">
          <img
        ...
        <div className="w-[319px] hidden flex-row items-start justify-start text-default-color-primary">
          <div className="flex-1 rounded-regular1 flex flex-row items-center justify-center py-regular1 px-mediium1 border-[1px] border-solid border-default-color-primary">
...
export default Property1NotAcceptedDelaye;
