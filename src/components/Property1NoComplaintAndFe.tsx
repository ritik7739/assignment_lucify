...
const Property1NoComplaintAndFe: FunctionComponent = () => {
  return (
    <div className="w-[361px] rounded-regular2 bg-background-background-primary box-border max-w-full flex flex-col items-start justify-start p-2 gap-[12px] text-left text-xs text-text-text-dark font-button-button-text-secondary border-[0.5px] border-solid border-default-grey">
      ...
      <div className="self-stretch flex flex-row items-start justify-start gap-[15px]">
        ...
        <div className="rounded-xl bg-background-grey-light flex flex-row items-center justify-center py-small px-regular1 text-default-color-primary font-text-description-text">
...
export default Property1NoComplaintAndFe;
