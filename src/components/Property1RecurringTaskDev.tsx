...
export type Property1RecurringTaskDevType = {
  gUC153?: string;
  gUC1531?: string;
  quantity?: boolean;
...
const Property1RecurringTaskDev: FunctionComponent<
  Property1RecurringTaskDevType
> = ({
  gUC153,
  gUC1531,
  quantity,
  ...
  return (
    <div className="flex flex-col items-start justify-start text-left text-xs text-text-text-dark font-button-button-text-secondary">
      <div className="w-[336px] rounded-regular2 bg-background-background-primary box-border flex flex-col items-start justify-start p-2 gap-[12px] border-[0.5px] border-solid border-default-grey">
        ...
        <div className="w-[319px] rounded-regular1 bg-default-color-primary hidden flex-row items-center justify-center py-regular1 px-mediium1 box-border gap-[8px] text-default-color-primary-light">
          <img className="w-small3 relative h-small3" alt="" src={gUC1531} />
...
export default Property1RecurringTaskDev;
