...
const Scheduled: FunctionComponent<ScheduledType> = ({
  quantity,
  showCheckBox,
  showRectangleDiv,
  instruction2,
  ...
  return (
    <div className="w-[336px] rounded-regular3 bg-background-background-primary box-border flex flex-col items-start justify-start p-2 gap-[12px] text-left text-xs text-text-text-dark font-button-button-text-secondary border-[0.5px] border-solid border-default-grey">
      ...
      <div className="self-stretch rounded-xl flex flex-row items-start justify-start text-royalblue">
