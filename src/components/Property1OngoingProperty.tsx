...
export type Property1OngoingPropertyType = {
  gUC153?: string;
  quantity?: boolean;
...
const Property1OngoingProperty: FunctionComponent<
  Property1OngoingPropertyType
> = ({
  gUC153,
  quantity,
  showCheckBox,
  ...
  return (
    <div className="w-[360px] max-w-full flex flex-col items-start justify-start text-left text-xs text-text-text-dark font-text-description-text">
      <div className="self-stretch rounded-regular2 bg-background-background-primary flex flex-col items-start justify-start p-2 gap-[12px] border-[0.5px] border-solid border-default-grey">
        <div className="self-stretch flex flex-row items-center justify-start text-background-background-primary">
          <div className="flex flex-row items-center justify-start gap-[4px]">
            ...
            <div className="rounded-xl bg-background-grey-light flex flex-row items-center justify-center py-small px-regular1 text-accent-ongoing-accent">
              <div className="relative font-medium">Ongoing</div>
            </div>
        ...
        <div className="self-stretch flex flex-row items-start justify-start gap-[15px] text-base font-button-button-text-secondary">
        ...
        <div className="self-stretch flex flex-row items-center justify-between text-text-text-dark-secondary font-button-button-text-secondary">
          <div className="flex flex-row items-center justify-center">
...
export default Property1OngoingProperty;
